...
class P4Q1Parser(BaseModel):
    place_holder: str = Field(description="The main persona placeholder name in the text")
...
class P4Q3Parser(BaseModel):
    gender: str = Field(description="The gender of the main persona (use your knowledge))")

class P4Q4Parser(BaseModel):
    min_age: str = Field(description="The minimum estimated age of the main persona (use your knowledge)")
    max_age: str = Field(description="The maximum estimated age of the main persona (use your knowledge)")

class P4Q5Parser(BaseModel):
    nation: str = Field(description="The nation of the main persona (use your knowledge)")
