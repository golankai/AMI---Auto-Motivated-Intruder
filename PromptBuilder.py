...
class PromptBuilder:
    ...
    def _get_pls_de_identify_prompt(self) -> tuple[PromptTemplate, StructuredOutputParser]:
        response_schemas = [
        ResponseSchema(name="re-identifiable", description="Is it re-identifiable?", type="boolean"),
        ResponseSchema(name="name", description="Name of the person or FAIL", type="str"),
        ResponseSchema(name="score", description="The score or re-identifiabilization", type="float")
