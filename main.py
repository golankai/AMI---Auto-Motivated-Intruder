...
result_csv_path = "results/study2/process5/exp1"
...
def analyzer():
    result_analyzer = ResultsAnalyzer(f"{result_csv_path}.csv")
    for persona in Persona:
        print(f"Accuracy for {persona.value}: {result_analyzer.persona_accuracy(persona)}")
