...
class ConversationHandler:
    ...
    def new_human_prompt(self, template: PromptTemplate, parser: StructuredOutputParser, user_input: str=""):
    ...
    def send_new_message(self, template: PromptTemplate, parser: StructuredOutputParser, user_input: str=""):
